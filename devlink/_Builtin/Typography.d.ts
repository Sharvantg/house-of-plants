...
export declare function Paragraph(
  ...
  HTMLElement
>;
export declare function Emphasized(props: Props<"em">): React.JSX.Element;
...
export declare function Subscript(props: Props<"sub">): React.JSX.Element;
export declare function Superscript(props: Props<"sup">): React.JSX.Element;
